# Generated by Powerlevel10k configuration wizard on 2024-08-19 at 15:10 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_RC_FOREGROUND=208
  typeset -g POWERLEVEL9K_KUBECONTEXT_RC_VISUAL_IDENTIFIER_EXPANSION='👀'
  ...
  function prompt_openstack_cloud() {
    if [[ -v OS_PROJECT_NAME ]]; then
      p10k segment -f green -t "${OS_PROJECT_NAME}:${OS_REGION_NAME}"
    fi
  }
